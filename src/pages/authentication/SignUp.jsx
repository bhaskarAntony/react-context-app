                ...
                <div className="col-md-5 m-auto mt-5">
                    <form action="">
                        ...
                        <div className="form-group mt-4">
                            ...
                            <input type="text" placeholder='Enter your username' required className='form-control p-2' />
                        </div>
                        <div className="form-group mt-4">
                            <label htmlFor="" className="form-label">Email address</label>
                            <input type="email" placeholder='exampe@gmail.com' required className='form-control p-2' />
                        </div>

                        <div className="form-group mt-4">
                            <label htmlFor="" className="form-label">Phone number</label>
                            <input type="text" placeholder='exampe@gmail.com' required className='form-control p-2' />
                        </div>

                         <div className="form-group mt-3">
                            <label htmlFor="" className="form-label">Password</label>
                            <input type={showpassword==true?'text':'password'} placeholder='exampe@gmail.com' required className='form-control p-2' />
                        </div>
